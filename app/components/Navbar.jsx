  ...
  categories: [
    {
      ...
      sections: [
        ...
        },
        {
          ...
          items: [
            { name: 'Watches', href: '#' },
            { name: 'Purse', href: '/product?category=purse' },
      ...
      sections: [
        {
          ...
          name: 'Clothing',
          items: [
            { name: 'Kurtas', href: '/product?category=kurta' },
            { name: 'Shirts', href: '/product?category=shirts' },
            { name: 'Sherwanis', href: '#' },
            { name: 'T-Shirts', href: '#' },
            { name: 'Bottoms', href: '#' },
          ...
          >
            ...
            <div className="space-y-6 border-t border-gray-200 px-4 py-6">
              <div className="flow-root">
                <a href="#">
                  <Avatar alt="Anu" src="" className="w-8 h-8 cursor-pointer bg-pink-400" />
                </a>
              </div>
            </div>
            ...
            <div className="flex h-16 items-center">
                  ...
                  {navigation.categories.map((category, index) => (
                    ...
                    >
                      <div className="relative flex">
                        <PopoverButton className="relative z-10 -mb-px flex items-center text-sm font-medium text-gray-700 transition-colors duration-200 ease-out hover:text-pink-500 focus:outline-none
                            after:content-[''] after:absolute after:left-0 after:bottom-6 after:w-0 after:h-[2px] after:bg-pink-400 after:transition-all after:duration-300 hover:after:w-full">
                          {category.name}
                        </PopoverButton>
                      ...
                      <PopoverPanel
                        className={`absolute inset-x-0 top-full text-sm text-gray-500 transition ${openPopover === index ? "block" : "hidden"
                          }`}
                      >
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  <a href="#">
                    <Avatar alt="Anu" src="https://i.pinimg.com/474x/2a/04/04/2a0404ce2a65687cee7b25b1f6ebe92e.jpg" className="w-8 h-8 cursor-pointer bg-pink-400 object-top object-fill" />
                  </a>
