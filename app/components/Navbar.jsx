                  ...
                  {navigation.categories.map((category) => (
                    <Popover key={category.name} className="flex">
                      <div className="relative flex">
                        <PopoverButton className="relative z-10 -mb-px flex items-center  hover:text-pink-500 pt-px text-sm font-medium text-gray-700 transition-colors duration-200 ease-out  data-open:border-indigo-600 data-open:text-indigo-600 hover:underline-offset-8 hover:underline">
                          {category.name}
                        </PopoverButton>
                      </div>
